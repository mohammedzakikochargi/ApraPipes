...
void Mp4WriterSinkUtils::parseTS(uint64_t &ts, uint32_t &chunkTimeInMinutes, uint32_t &syncTimeInMinutes,
	...
	uint32_t chunkTimeInMinutes, uint32_t syncTimeInMinutes, bool &syncFlag)
{
	...
	parseTS(timestamp, chunkTimeInMinutes, syncTimeInMinutes, relPath, mp4FileName, syncFlag);
